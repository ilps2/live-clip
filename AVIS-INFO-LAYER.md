...
| 视频类型 | 运动量 | 静态率 | 自然色 | 语音 | 路由结果 |
|---------|--------|--------|--------|------|---------|
| 风景 vlog | 0.13 | 1.0 | 0.50 | 100% | static_scenery ✅ |
| 播客对谈 | 0.07 | 1.0 | 0.13 | 100% | speech_dense ✅ |
| 美食教程 | 2.86 | 0.0 | 0.0 | 100% | speech_dense ✅ |
| 新闻播报 | 2.57 | 0.5 | 0.89 | 98% | speech_dense ✅ |
| 体育(解说) | 2.08 | 0.5 | 0.33 | 100% | speech_dense ✅ |
| 体育(静音) | 3.07 | 0.0 | 0.38 | 0% | mixed ⚠️ 模拟运动强度未达阈值 |

语音主导类与静态自然类全部正确路由；纯运动视频因模拟运动强度不足归 mixed（真实体育运动量远超阈值）。路由阈值可在真实数据上校准。
